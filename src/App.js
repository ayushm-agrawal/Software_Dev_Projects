    ...
    return (
      <div className="App">
        <ul id="ul">
          ...
          <li><a href="#b">Methane Gas</a></li>
          <li><a href="#c">Hunger</a></li>
          <li><a href="#d">Reducing Food Waste</a></li>
        </ul>
        <div id="container">
